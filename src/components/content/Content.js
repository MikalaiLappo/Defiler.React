...
export default function Content(props) {
    return (
        <div className="content">
            ...
            <a href="./tourney/"><img src="https://supply.defiler.ru/img/dt/dtour.jpg" style={{width: 250, marginTop: 30}}/></a>
            <br/>
            <a href="https://discord.gg/pgKarQn" target="_blank">discord group</a>
        </div>
    )
}