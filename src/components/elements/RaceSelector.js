    ...
    return (
        <div className={containerClasses}>
            ...
            <div className="input-edit race-pick clearfix">
                <div className={value === 'terran' ? 'active race-terran-big' : 'race-terran-big'} onClick={setTerran} />
                <div className={value === 'zerg' ? 'active race-zerg-big' : 'race-zerg-big'} onClick={setZerg}/>
                <div className={value === 'protoss' ? 'active race-protoss-big' : 'race-protoss-big'} onClick={setProtoss}/>
                <div className={value === 'random' ? 'active race-random-big' : 'race-random-big'} onClick={setRandom}/>
            </div>
        </div>
    )
}